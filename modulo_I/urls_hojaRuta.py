...
urlpatterns = [
    ...
    url(r'^alta/balde/hoja_de_ruta/(?P<id_hoja>\d+)/$', alta_modif_balde_utilizado, name="alta_modif_balde_utilizado"),
    ...
    url(r'^baja/balde/$', baja_balde_utilizado, name="baja_balde_utilizado"),
    #liquidacion mensual
