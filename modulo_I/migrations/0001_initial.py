# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2018-03-02 16:25
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('recorrido', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='modulo_I.Recorrido')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.AlterUniqueTogether(
            name='recorridoestablecimiento',
            unique_together=set([('establecimiento_generador', 'recorrido', 'nro_parada', 'dia')]),
        ),
        migrations.AlterUniqueTogether(
            name='baldepactado',
